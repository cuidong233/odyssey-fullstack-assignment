...
export const dictionaries = {
  en: {
    ...
    menu: { eyebrow: "Catalog", title: "Menu", items: "Items", availability: "Availability and pricing", add: "Add item", create: "Add menu item", available: "Available", paused: "Paused", edit: "Edit menu item", name: "Name", description: "Description", category: "Category", price: "Price", image: "Image", uploadImage: "Upload image", defaultImage: "Default image", availableForOrdering: "Available for ordering", save: "Save item", createSave: "Create item", validation: "Add a name, category, and price greater than zero." },
  ...
  zh: {
    ...
    menu: { eyebrow: "商品目录", title: "菜单", items: "菜品", availability: "可售状态与价格", add: "添加菜品", create: "添加菜品", available: "可售", paused: "暂停", edit: "编辑菜品", name: "名称", description: "描述", category: "分类", price: "价格", image: "图片", uploadImage: "上传图片", defaultImage: "默认图片", availableForOrdering: "开放点单", save: "保存菜品", createSave: "创建菜品", validation: "请填写名称、分类，并输入大于 0 的价格。" },
