...
export const dictionaries = {
  en: {
    ...
    crm: { eyebrow: "Guest intelligence", title: "CRM", customers: "Customers", stats: "Spend and order history", sort: "Highest spend", lastOrder: "Last order", spend: "Spend", edit: "Edit", save: "Save customer", validation: "Add a customer name before saving." },
  ...
  zh: {
    ...
    crm: { eyebrow: "客户洞察", title: "客户", customers: "客户", stats: "消费与订单历史", sort: "消费最高", lastOrder: "最近订单", spend: "消费", edit: "编辑", save: "保存客户", validation: "保存前请填写客户姓名。" },
