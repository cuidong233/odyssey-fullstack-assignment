...
const dictionaries = {
  en: {
    ...
    menu: { eyebrow: "Catalog", title: "Menu", items: "Items", availability: "Availability and pricing", add: "Add item", available: "Available", paused: "Paused", edit: "Edit menu item", price: "Price", availableForOrdering: "Available for ordering", save: "Save item" },
    ...
    library: { eyebrow: "Design system", title: "UI Library", tokens: "Tokens", colorSpacing: "Color and spacing", components: "Components", states: "States", primary: "Primary", secondary: "Secondary", disabled: "Disabled", success: "Success", warning: "Warning", error: "Error", info: "Info" },
  ...
  zh: {
    ...
    menu: { eyebrow: "商品目录", title: "菜单", items: "菜品", availability: "可售状态与价格", add: "添加菜品", available: "可售", paused: "暂停", edit: "编辑菜品", price: "价格", availableForOrdering: "开放点单", save: "保存菜品" },
    settings: { eyebrow: "业务控制", title: "设置", ordering: "点单", rules: "服务规则", open: "开放点单", autoAccept: "自动接单", prep: "默认备餐时间", tax: "税率", hours: "营业时间" },
    library: { eyebrow: "设计系统", title: "组件库", tokens: "设计变量", colorSpacing: "颜色与间距", components: "组件", states: "状态", primary: "主按钮", secondary: "次按钮", disabled: "禁用", success: "成功", warning: "警告", error: "错误", info: "信息" },
